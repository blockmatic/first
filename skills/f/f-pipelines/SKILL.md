---
name: f-pipelines
description: Apply Pipelines First with a pipelines lens who inspects this repo as a data analyst. Use when the user types /f-pipelines or /f pipelines.
disable-model-invocation: true
---

Apply Pipelines First with a pipelines lens.

1. Read [../references/analyst.md](../references/analyst.md).
2. Read `_first/FIRST.md`. Take the In path for `pipelines:`. If that station is Out, stop and say so.
