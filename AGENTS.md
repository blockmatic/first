...
- `.agents/skills/` — tech skills and `/workflow` playbooks from `blockmatic/basilic-skills`; FIRST `/f-*` from this repo (`npx skills add blockmatic/first` or `npx skills add .`)
