...
Copy `README.md`, `AGENTS.md`, and `ABOUT.md` from `_first/` into `_first/` of your product repo. Add `FIRST.md`. Write overlays only for stations listed as In. Skip `instance/`, `maintainers/`, `principles/`, and `articles/`. Install with `npx skills add blockmatic/first`. Details: [Packaging](https://github.com/blockmatic/first/blob/main/_first/maintainers/PACKAGING.md) and `/docs` on the site.
