...
- Complements [ahooks-v3](../ahooks-v3/SKILL.md) for grouped/local state not in the URL
- Complements [tanstack-query-v5](../tanstack-query-v5/SKILL.md) for async server data (loading/error from queries)
- State decision tree: URL-shareable UI → nuqs; grouped ephemeral UI → ahooks; async data → TanStack Query
