---
name: b-run-all-tests-and-fix
description: Execute full test suite and systematically fix any failures, ensuring code quality and functionality. Use when the user types /b-run-all-tests-and-fix.
