---
name: b-fix-git-issues
description: Help resolve common Git problems and conflicts with step-by-step commands and explanations. Use when the user types /b-fix-git-issues.
