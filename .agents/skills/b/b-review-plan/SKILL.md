---
name: b-review-plan
description: Review the attached or in-context plan against the current plan contract. Use when the user types /b-review-plan.
disable-model-invocation: true
---

## Purpose and inputs

Use the attached or in-context plan, the matching implementation, and [b-plan-feature](../b-plan-feature/SKILL.md). Stay read-only. Do not create files, branches, or scaffolds.
...
Return whether the plan is implementable as written, the first blocked slice, and what must change before `/b-build`. An inspection is not approval to implement.
