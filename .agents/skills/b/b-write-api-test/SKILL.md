---
name: b-write-api-test
description: Create comprehensive tests for API endpoints validating behavior through external interactions. Use when the user types /b-write-api-test.
