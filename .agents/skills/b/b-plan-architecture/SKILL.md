---
name: b-plan-architecture
description: Produce a structured architectural plan with explicit goals, trade-offs, and visual diagrams. Use when the user types /b-plan-architecture.
