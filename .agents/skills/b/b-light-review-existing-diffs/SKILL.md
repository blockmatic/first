---
name: b-light-review-existing-diffs
description: Perform quick quality pass on current diffs to surface risky areas, ensure polish, and flag follow-up actions for deeper review. Use when the user types /b-light-review-existing-diffs.
