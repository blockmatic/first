---
name: f-operations
description: Apply Operations First with an operations lens who inspects this repo as a data analyst. Use when the user types /f-operations or /f operations.
disable-model-invocation: true
---

Apply Operations First with an operations lens.

1. Read [../references/analyst.md](../references/analyst.md).
2. Read `_first/FIRST.md`. Take the In path for `operations:`. If that station is Out, stop and say so.
