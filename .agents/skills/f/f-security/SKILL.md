---
name: f-security
description: Apply Security First with a security lens who inspects this repo as a data analyst. Use when the user types /f-security or /f security.
...
2. Read `_first/FIRST.md`. Take the In path for `security:`. If that station is Out, stop and say so.
