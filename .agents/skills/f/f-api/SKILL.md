---
name: f-api
description: Apply API First with an API lens who inspects this repo as a data analyst. Use when the user types /f-api or /f api.
disable-model-invocation: true
---

Apply API First with an API lens.

1. Read [../references/analyst.md](../references/analyst.md).
2. Read `_first/FIRST.md`. Take the In path for `api:`. If that station is Out, stop and say so.
