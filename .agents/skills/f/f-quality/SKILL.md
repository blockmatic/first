---
name: f-quality
description: Apply Quality First with a quality lens who inspects this repo as a data analyst. Use when the user types /f-quality or /f quality.
disable-model-invocation: true
---

Apply Quality First with a quality lens.

1. Read [../references/analyst.md](../references/analyst.md).
2. Read `_first/FIRST.md`. Take the In path for `quality:`. If that station is Out, stop and say so.
