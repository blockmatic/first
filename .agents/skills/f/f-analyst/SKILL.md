---
name: f-analyst
description: Apply Data First as a data analyst who inspects this repo as a data analyst. Use when the user types /f-analyst or /f data.
disable-model-invocation: true
---

Apply Data First as a data analyst.

1. Read [../references/analyst.md](../references/analyst.md).
2. Read `_first/FIRST.md`. Take the In path for `data:`. If that station is Out, stop and say so.
